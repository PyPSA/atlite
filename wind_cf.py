...
lon_offset = 250 / (95 * cos(radians(center_lat))) / 2  # Half of 30km in degrees longitude
...
cap_factors = cutout.wind(turbine="NREL_ReferenceTurbine_2020ATB_5.5MW", capacity_factor_timeseries=True)
