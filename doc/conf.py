...
latex_documents = [
  (master_doc, 'atlite.tex', u'atlite Documentation',
   u'author', 'manual'),
]
...
rinoh_documents = [(master_doc,            # top-level file (index.rst)
                    'atlite',           # output (target.pdf)
                    'atlite Documentation',   # document title
...
man_pages = [
    (master_doc, 'atlite', u'atlite Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'atlite', u'atlite Documentation',
   author, 'atlite', 'One line description of project.',
   'Miscellaneous'),
]
