...
"""
Module for downloading and curating forecast data from different weather prediction models (via Open-Meteo).
...
meteo_url1 = "https://api.open-meteo.com/v1/forecast"
meteo_url2 = "https://api.open-meteo.com/v1/ecmwf"
...
requirements = {'x': slice(-90, 90, 0.1),
                'y': slice(-90, 90, 0.1),
                'offset': pd.Timedelta(hours=-92.0*24),
                'forecast': pd.Timedelta(hours=16.0*24),
...
def get_data_meteo_runoff(retrieval_params):
    """Get all data from meteo API for given retrieval parameters at once to save requests and runtime."""
