...
"""
Module for downloading and curating data from DWD ICON dataset (via ODS).
...
# Local Resource Data Folder
RESOURCE_DIRECTORY = Path(__file__).parent.parent / "resources"
GRID_DIRECTORY = RESOURCE_DIRECTORY / "grid"

# Local Data Grid Folder
dwd_icon_grid = "icon_grid_0026_R03B07_G"
dwd_icon_grid_description_folder = "ICON_GLOBAL2WORLD_0125_EASY"
...
def _regrid_data(tmp_data_filepath, var, coords, area, grid, tmpdir):
    """
